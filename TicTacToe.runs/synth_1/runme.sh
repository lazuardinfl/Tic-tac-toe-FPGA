...
HD_PWD='C:/Users/Ardi/Vivado/Project/TicTacToe/TicTacToe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_tictactoe_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_tictactoe_wrapper.tcl
