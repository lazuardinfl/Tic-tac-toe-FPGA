...
HD_PWD='C:/Users/Ardi/Vivado/Project/TicTacToe/TicTacToe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_tictactoe_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_tictactoe_wrapper.tcl -notrace
