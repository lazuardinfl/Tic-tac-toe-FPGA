...
HD_PWD='C:/Users/Ardi/Vivado/Project/TicTacToe/TicTacToe.runs/design_tictactoe_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_tictactoe_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_tictactoe_axi_gpio_0_0.tcl
